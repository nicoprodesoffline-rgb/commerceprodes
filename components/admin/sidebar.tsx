...
const navLinks: NavLink[] = [
  ...
  { href: "/admin/familles", label: "Familles produits", icon: "🔗", badge: "BÊTA" },
  { href: "/admin/variations", label: "Variations", icon: "🧬", badge: "BÊTA" },
  { href: "/admin/categories", label: "Catégories", icon: "🗂️" },
  { href: "/admin/data-factory", label: "Data factory", icon: "🏭", badge: "BÊTA" },
