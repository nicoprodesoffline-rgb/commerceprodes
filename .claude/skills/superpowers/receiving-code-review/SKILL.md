...
### From the user (direct instructions)
...
### From External Reviewers (PR reviews, Codex output)
...
BEFORE implementing:
  ...
  4. Check: Works with current Next.js/Supabase/TypeScript versions?
...
FOR multi-item feedback:
  ...
  4. Verify no regressions (npx tsc --noEmit)
```
...
- Technically incorrect for this stack (Next.js 15, Supabase, TypeScript)
- Legacy/compatibility reasons exist
- Conflicts with architectural decisions (e.g. EAV → JSONB migration plan, PUID system)
