...
4. **Gather Evidence in Multi-Component Systems**
   ...
   **Example (multi-layer system):**
   ...
   # Layer 1: Env vars
   echo "=== Env vars: ==="
   env | grep NEXT_PUBLIC || echo "Not found"
   ...
   **This reveals:** Which layer fails first.
...
Extended support techniques (root-cause-tracing, defense-in-depth, condition-based-waiting) are available in the [obra/superpowers](https://github.com/obra/superpowers) repo under `skills/systematic-debugging/`.
