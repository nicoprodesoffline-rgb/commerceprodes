...
const STEPS = [
  {
    ...
    label: "Demande reçue",
    icon: "✅",
    statuses: ["pending", "contacted", "confirmed"],
  },
  {
    key: "processing",
    label: "En traitement",
    ...
    <>
      <div className="mx-auto max-w-xl px-4 py-10">
        <nav className="mb-6 flex items-center gap-1.5 text-sm text-gray-500">
          <Link href="/" className="hover:text-[#cc1818] transition-colors">
            Accueil
          </Link>
          <span>/</span>
        ...
        <p className="mb-6 text-sm text-gray-500">
          ...
          <span className="font-mono font-semibold text-gray-800">
            {(order as any).id.slice(0, 8).toUpperCase()}
          </span>
          {" · "} Passée le {createdAt}
        </p>
        ...
        <div className="mt-6 rounded-lg border border-gray-200 bg-gray-50 p-4 text-center text-sm text-gray-500">
          ...
          {" · "}
          ✉️{" "}
          <a href="mailto:contact@prodes.fr" className="hover:text-[#cc1818]">
            contact@prodes.fr
          </a>
