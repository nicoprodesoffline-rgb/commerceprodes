      ...
      <main className="mx-auto max-w-2xl px-4 py-12">
        ...
        <div className="mb-8 text-center">
          ...
          <p className="mt-3 text-base text-gray-600">
            ...
            Décrivez votre besoin, nous vous envoyons un devis personnalisé
            rapidement.
          </p>
        </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="mt-4 space-y-4">
                ...
                {isPublicOrg && (
                  <div className="rounded-lg border border-blue-200 bg-blue-50 px-4 py-3 text-sm text-blue-800">
                    🏛️ <strong>Chorus Pro compatible</strong> — nous acceptons
                    le bon de commande administratif et la facturation Chorus
                    Pro.
                  </div>
                )}
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={handleChange}
                    placeholder="Mairie de Montpellier"
                    className={inputClass}
                  />
                </div>
              </div>
            ...
            <label className="flex cursor-pointer items-start gap-3">
              ...
              <span className="text-sm text-gray-600">
                J&apos;accepte que PRODES conserve mes coordonnées pour traiter
                ma demande de devis.
              </span>
            </label>
            ...
            <p className="text-center text-xs text-gray-400">
              ...
              <a
                ...
                className="font-medium text-gray-600 hover:text-[#cc1818]"
              >
                04 67 24 30 34
              </a>
            </p>
